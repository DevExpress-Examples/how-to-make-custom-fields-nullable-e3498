...
%>
						<dxe:ASPxDropDownEdit id="ddResource" runat="server" Width="100%" ClientInstanceName="ddResource" Enabled='<%#(CType(Container, UserAppointmentFormTemplateContainer)).CanEditResource%>' AllowUserInput="false">
...
<%
   Else
%>
						<dxe:ASPxComboBox ClientInstanceName="_dx" ID="edtResource" runat="server" Width="100%" DataSource='<%#ResourceDataSource%> ' Enabled='<%#(CType(Container, UserAppointmentFormTemplateContainer)).CanEditResource%>' />
<%
   End If
%>
					</td>
		...
		<td class="dxscSingleCell">
			<table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="dxscControlCell">
			<dxe:ASPxTextBox ID="tbField1" runat="server" Width="100%" Text='<%#(CType(Container, UserAppointmentFormTemplateContainer)).Field1%>' BackColor="Ivory">
			</dxe:ASPxTextBox>
					</td>
				</tr>
			</table>
